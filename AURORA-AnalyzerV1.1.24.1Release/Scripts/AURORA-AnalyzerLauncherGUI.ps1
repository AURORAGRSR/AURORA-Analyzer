...
# LauncherGUI Version: V1.1.20.0Release
# 作者：AURORA VelociRaptor-GR Dev PRJ.| 构建时间：2026.05.27
...
if (-not [string]::IsNullOrWhiteSpace($AURORA_WD_PIPE_NAME)) {
    try {
        ...
        $AURORA_WD_PIPE.Connect(8000)

        # 初始化握手: 接收 HMAC 密钥
        $AURORA_WD_HANDSHAKE = New-Object byte[] 49
        $AURORA_WD_READ = 0
        while ($AURORA_WD_READ -lt 49) {
        ...
        Write-Host "[看门狗] 连接失败: $($_.Exception.Message)" -ForegroundColor DarkGray
        $AURORA_WATCHDOG_ACTIVE = $false
    }
}
...
public class AuroraGuard
{
    `private static readonly Dictionary<string, string> _expected = new Dictionary<string, string>
    {
        ...
        { "Scripts\\AURORA-AnalyzerCHSPRO.ps1", "1d2b8668e0a27ab5b7aba8aec63218b886bbc8e61639119e533247bcbe1b8c52" },
        { "Scripts\\AURORA-ProgressManager.ps1", "2c6567502d082620d91999b2485552c636228a96fd6330023ff308d0c3c7b553" },
        { "Scripts\\AURORA-GUI-Functions.ps1", "7697a5cc3f2e7d0f876896ed24bc3ce12814c385d56ababda93f02fdb389f557" },
        { "Scripts\\AURORA-RepairTools.ps1", "b6f5dcf3e368ab71470ebabeb6c879a9b5e032340d3c007f6fbed87948c0137d" },
        { "Scripts\\AURORA-UndoManager.ps1", "26747d41655cab6db666e91a4ec973c88d2f2394992dae0b85906dc7721d6727" },
        { "Scripts\\AURORA-RestoreManager.ps1", "1314dbb9ebd09b9f017d0e6c16feff3ac674f82df2bdeff537966543e3c90f95" },
        { "Scripts\\AURORA-RepairLogger.ps1", "daa9f8d48c0138c8b9dfe041c948dbc3881f6cf40be8282f2cffd0a559863157" },
        { "Scripts\\AURORA-UndoViewer.ps1", "1316b492342f90dfaa28ae506f292a37c9d87ad3d3ef24e4dcc493e981a1cb90" },
        { "Scripts\\AURORA-AnalyzerPRO.ps1", "3a8ec2f281d5afbf30f4e03eda8f5a64bdfa4e696b96eda87e54662792892657" },
        { "Scripts\\AURORA-ProgressManager-Integration.ps1", "41a484ed871db8c3779b141e76f9cd2c8f5ba6e69f6d017ff837ab97f982f2e6" },
        { "Scripts\\AURORA-ProgressManager-Integration-CHS.ps1", "483ef08a33ba9e4d81f907364520ef24b22c4875e4947c623b46356b1753d71a" },
        { "Scripts\\AURORA-ProgressManager-Integration-ENG.ps1", "d13b07d3d87be4be8cdfce570f3995428cb2c6aa4d1c588bc540260118b93aee" },
    ...
    public static bool CheckIntegrity()
    {
        try
        {
            if (_baseDir == null || _expected.Count == 0) return false;
...
$global:syncHash = [hashtable]::Synchronized(@{
    ...
    RequestElevation = $false  # [PRO->GUI] 请求提权确认
