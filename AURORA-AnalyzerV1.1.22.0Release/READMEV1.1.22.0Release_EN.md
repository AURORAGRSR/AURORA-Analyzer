# AURORA Analyzer v1.1.22.0 Release Notes

> **Making Windows Event Logs No Longer Obscure — One-Click Export, Intelligent Diagnostics, Autonomous Repair**
>
> **Version**: 1.1.22.0 Release | **Build Date**: 2026.05.14 | **Author**: AURORA VelociRaptor-GR Dev PRJ.
...
- High-risk operations trigger **holographic authorization popups**, requiring your 逐项 confirmation before execution
...
| File                                           | Purpose                           |
| ---------------------------------------------- | --------------------------------- |
| `Scripts\AURORA-AnalyzerLauncherGUI.ps1`     | GUI main program                  |
| `Scripts\AURORA-AnalyzerPRO.ps1`             | PRO mode unified entry point      |
| `Scripts\AURORA-AnalyzerCHSPRO.ps1`          | Chinese version log export engine |
| `Scripts\AURORA-AnalyzerENGPRO.ps1`          | English version log export engine |
| `Scripts\AURORA-CoreEngine.ps1`              | Shared core engine                |
| `Scripts\AURORA-SmartEngine.ps1`             | Intelligent diagnostic & repair engine |
| `Scripts\AURORA-ProgressManager.ps1`         | Task progress save & restore      |
| `Scripts\AURORA-ProgressManager-Integration.ps1` | Unified progress integration layer |
| `Scripts\AURORA-ProgressManager-Integration-CHS.ps1` | Chinese progress integration |
| `Scripts\AURORA-ProgressManager-Integration-ENG.ps1` | English progress integration |
...
| File                                           | Purpose                           |
| ---------------------------------------------- | --------------------------------- |
| `Data\AURORA-TechData.json`                  | Diagnostic knowledge base (6 major diagnostic rule categories) |
